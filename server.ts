...
// Log das variáveis de ambiente (sem expor secrets completos)
console.log('[Config] B2_ACCOUNT_ID:', B2_CONFIG.accountId ? '✓ Configurado (' + B2_CONFIG.accountId.substring(0, 8) + '...)' : '✗ Não configurado');
console.log('[Config] B2_APPLICATION_KEY:', B2_CONFIG.applicationKey ? '✓ Configurado' : '✗ Não configurado');
console.log('[Config] B2_BUCKET_NAME:', B2_CONFIG.bucketName ? '✓ ' + B2_CONFIG.bucketName : '✗ Não configurado');
console.log('[Config] B2_BUCKET_ID:', B2_CONFIG.bucketId ? '✓ ' + B2_CONFIG.bucketId : '✗ Não configurado');
